...
% don't try to load fontspec as this breaks Helvetica as default text font
% (the default math font will be alright with the no-math option to fontspec,
% but the text font will still be CM Sans...)
\makeatletter
...
""",
  ...
  def save(self, graphicsNumber=None, hideSpines=True, tightLayout=True, crop=True, close=True):
